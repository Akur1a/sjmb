<template>
  <div style="width:1572px">
    <div v-for="(item,index) in pageList"
      ...
      <!--装订线-->
      <div class="dashedLine" v-if="index===0 || (index+1)%2 !=0">
      ...
      <div style="margin-top:5px;"
           ...
           {marginLeft:index===0 || (index+1)%2 !=0?'125px':'31px'},
           {width:index===0 || (index+1)%2 !=0?'630px':'724px'}]"
           ref="page"
           class="STArea"></div>
      <!-- 卷尾 -->
  ...
  export default {
    ...
    methods: {
      ...
      putDTSM(val, count, nextTxt) {
        // 切分放置大题说明
        let pageWidth = (this.pageNo+1)%2 == 0 ? '724':'630'//双面724
        let pureTxt = val
        ...
        if (this.pageList[this.pageNo].height >= domHeight1 - 27) {
          ...
          if (nextTxt) {
            ...
            this.pageNo++
            pageWidth = (this.pageNo+1)%2 == 0 ? '724':'630'//双面724
      ...
      inputFn(htmlTxt, pureTxt) {
        ...
        //生成虚拟dom,获取富文本高度
        let pageWidth = (this.pageNo+1)%2 == 0 ? '724':'630'//双面宽724
        let creatDiv = document.createElement("div");
      ...
      inputFn1(txt, pureTxt, count, nextTxt) {
        ...
        creatDiv.style.display = "none";
        pageWidth = (this.pageNo+1)%2 == 0 ? '724':'630'//双面宽724
      ...
      async inputLine(count, max, val) {
        //空行
        let pageWidth = (this.pageNo+1)%2 == 0 ? '724':'630'
        ...
        pageWidth = (this.pageNo+1)%2 == 0 ? '724':'630'
        if (this.$refs.page[this.pageNo]) {
